    ...
    <>
      ...
      <div className='flex flex-col items-center justify-between w-10/12 md:w-7/12 lg:w-4/12 px-5 py-4  bg-gray-800 shadow-md'>
        <p className='flex items-center justify-between w-full'>
          ...
          <span className='text-green-300 text-3xl font-semibold'>
            {characterLength || 0}
          </span>
        </p>
        <SliderProgress
        ...
        />
        <CheckBoxes setPasswordStrengthCounter={setPasswordStrengthCounter} passwordStrengthCounter={passwordStrengthCounter} />
